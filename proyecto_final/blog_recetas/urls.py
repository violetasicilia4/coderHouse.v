...
from .views import home, ejemplo_blog, ejercicio, Ejercicio_LV, persona, Persona_LV, Ejercicio_DV, loginView, registerView, modals_prueba, about, editarPerfil, nosotros, contacto, Ejercicio_Create,Ejercicio_Actualizar,Ejercicio_Eliminar
